...
export default function HeadConfig() {
  return (
    ...
    <Head>
      ...
      <title>Contact Page | Simón Calle Laverde | Portfolio 2025 | Web Design and Web Development | Digital Product Design | UX Design and UI Design | Chía, Cundinamarca, Colombia</title>
