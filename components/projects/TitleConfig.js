...
export default function HeadConfig() {
  return (
    ...
    <Head>
      ...
      <title>Projects Page | Simón Calle Laverde | Portfolio 2025 | Web Design and Web Development | Digital Product Design | UX Design and UI Design | Chía, Cundinamarca, Colombia | Projects: | Calle Impresores SAS. | Cultsure LLC. | Frog Talk LTD. | Jomaira Imagen | Seed Your Future | Repower Australia | Bogota Bulldogs | Grand Theft Auto VI Trailer 2</title>
