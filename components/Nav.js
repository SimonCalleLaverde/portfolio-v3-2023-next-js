    ...
    <nav className="top-nav">
      <div className="container display-flex justify-content-end">{/*align-items-center*/}
        ...
        <ul className="display-flex align-items-center">{/*justify-content-between*/}
          ...
          <li>
            <Link className="link-underline" href="https://simoncallelaverde.github.io/projects" target="_blank" rel="noreferrer" title="Like with every movie sequel, my first Portfolio 2021 was way better! See 30 more Front-end Development projects there.">
              {/*Relevant work*/}
              {/*Other work*/}
              {/*More work*/}
              Development work
