...
export default function HeadConfig({ title }) {
  return (
    ...
    <Head>
      ...
      <title>Project (Per-Project) Page | Simón Calle Laverde | Portfolio 2025 | Web Design and Web Development | Digital Product Design | UX Design and UI Design | Chía, Cundinamarca, Colombia</title>
