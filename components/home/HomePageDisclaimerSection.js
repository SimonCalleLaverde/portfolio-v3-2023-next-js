...
export default function HomePageDisclaimerSection() {
  return (
    ...
    <section className="homepage-disclaimer-section font-light text-start">{/*font-ultra-light*/}
        ...
        <div className="row">
          <div className="col-md-8">{/*col-md-10*/}
            ...
            */}
            ...
            <p>
              Since 2024 I&apos;m again coming back to the digital work-forces{/* after some print and varied work*/}.
            </p>
