  ...
  return (
    ...
    <div className="cube-3d-scene-container">
      <div className="cube">
        ...
        <div className="face right background-image-default" type="image" style={{ backgroundImage:"url('/profile-images/nena-facebook-video-screenshot-(cropped).png')" }} title="Simón Calle Laverde and his cat Ñeña in a pure HTML & CSS 3D rotating cube" aria-hidden="true">
        </div>
        ...
        <div className="face left background-image-default" type="image" style={{ backgroundImage:"url('/profile-images/nena-facebook-video-screenshot-(cropped).png')" }} title="Simón Calle Laverde and his cat Ñeña in a pure HTML & CSS 3D rotating cube" aria-hidden="true">
        </div>
