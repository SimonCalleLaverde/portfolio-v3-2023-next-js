  ...
  return (
    ...
    <div className="cube-3d-scene-container">
      <div className="cube">
        ...
        <div className="face right background-image-default" type="image" style={{ backgroundImage:"url('/home-page-images/home-header-picture-ii-(cropped)-(tinypng).jpg')" }} title="Pure HTML & CSS 3D rotating cube featuring Simón, Ñeña, and Kiri" aria-hidden="true">
        </div>

        <div className="face bottom background-image-default" type="image" style={{ backgroundImage:"url('/home-page-images/nena-facebook-video-screenshot-(cropped)-(tinypng).png')" }} title="Pure HTML & CSS 3D rotating cube featuring Simón, Ñeña, and Kiri" aria-hidden="true">
        </div>

        <div className="face left background-image-default" type="image" style={{ backgroundImage:"url('/home-page-images/home-header-picture-ii-(cropped)-(tinypng).jpg')" }} title="Pure HTML & CSS 3D rotating cube featuring Simón, Ñeña, and Kiri" aria-hidden="true">
        </div>
