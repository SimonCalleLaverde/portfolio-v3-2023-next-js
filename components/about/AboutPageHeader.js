            ...
            <div className="about-header-middle text-center">
              ...
              <div>
                <div className="glitch-image-wrap">
                  <img className="glitch-img" src="/profile-images/about-header-picture-(original)-(tinypng).jpg" alt="Picture of Simón Calle Laverde"/>

                  <img className="glitch-img" src="/profile-images/about-header-picture-(original)-(tinypng).jpg" aria-hidden="true"/>
