...
export default function AboutPageMyselfSection() {
  return (
    ...
    <section className="aboutpage-myself-section">
      ...
      <img className="image-candelaria d-none d-md-block" src="/about-page-images/about-bogota-colombia-candelaria-image.jpg" alt=""/>
      <img className="image-england-port d-none d-md-block" src="/about-page-images/about-london-england-port-image.jpg" alt=""/>
      <img className="image-palm-beach d-none d-md-block" src="/about-page-images/about-colombia-palm-beach-image.jpg" alt=""/>
      <img className="image-bogota-colombia d-none d-md-block" src="/about-page-images/about-bogota-colombia-marcela-pinzon-image.jpg" alt=""/>
...
<p>I started my journey after graduating with a bachelor&apos;s degree as a <em className="font-ultra-light text-italic">Publicist</em> {/*with studies in marketing and advertising */}in the <Link href="https://www.utadeo.edu.co/es" target="blank">Universidad&nbsp;Jorge&nbsp;Tadeo&nbsp;Lozano</Link>. I wanted to apply my 5 years long career knowledge through digital platforms so I then took a continuing education program course in <em className="font-ultra-light text-italic">Web Design and Design for Mobile Devices</em> in a recognized university here in my country, the <Link href="https://www.javeriana.edu.co/home" target="blank">Pontificia&nbsp;Universidad&nbsp;Javeriana</Link>.</p>

<p>I then worked for over 4 years with the great team of <Link href="https://www.codenation.com/" target="blank">Code&nbsp;Nation</Link>, a 5 star rated international{/* company*/} digital agency based in Australia. There, we created dozens of robust and powerful campaign websites and platforms for both progressive and big organizations. {/*we had a couple of occations  where all the team could get together.*/}</p>

<p>In the past couple of years I have been learning much more about UI design, UX research and strategy, web best practices, and enhancing my design and coding skills alike. <Link href="/projects">Read&nbsp;&&nbsp;see&nbsp;more.</Link></p>
